    ...
    <div class="main">
      ...
      <div class="main_center">
        ...
        <div class="course_school box_height2">
          <div class="box_title">题库新增题量/题库学校排行</div>
          <div class="ti_box">
            <div class="barchart" id="barchart"></div>
            
          <div class="conect tipai">
            <div class="conectTitle">学校排行</div>
            <div class="tableBox">
              <div class="tableHead">
              <div class="head1">排名</div>
              <div class="head1">学校名称</div>
              <div class="head1">题库数量</div>
            </div>
            <div
              class="tableHead tableItem"
              v-for="(item, index) in tableList"
              :key="index"
            >
              <div class="head1">{{index+1}}</div>
              <div class="head1 heads">{{ item.school_name }}</div>
              <div class="head1">{{ item.qnr_cnt }}</div>
            </div>
            </div>
