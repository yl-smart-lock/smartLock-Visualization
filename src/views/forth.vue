<template>
  <div>
    ...
    <div class="nextPage rightw" @click="toPage1">上一页</div>
    ...
    <div class="main">
      <div class="left">
        ...
        <div class="left_bot left_bbt bg1">
          <div class="top_box">
            <div class="countItem">
              <div class="bg color3">
      ...
      <div class="center">
        <Geos id="china_map" :render_random="geo_render_random" datas="25rem"></Geos>
      </div>
      <div class="left">
        <div class="left_top bg1">
          <div class="top_box">
...
import Geos from "@/components/geo1";
