        ...
        >
          ...
          <div class="circleBox">
            <div class="circleItem">
              ...
              <div class="circleRight">
                <div class="top">
                  <span class="tit">研学路线：{{ reportDataName2 }}</span>
                  <span class="count1"></span>
                </div>
                <!-- <div class="top">
                    <span class="tit">占用数：</span>
            ...
            <div class="circleItem">
              ...
              <div class="circleRight">
                <div class="top">
                  <span class="tit">研学路线：{{ reportDataName3 }}</span>
                  <span class="count1"></span>
                </div>
                <!-- <div class="top">
                    <span class="tit">占用数：</span>
          ...
          <div class="circleBox">
            <div class="circleItem">
              ...
              <div class="circleRight">
                <div class="top">
                  <span class="tit">研学路线：{{ reportDataName4 }}</span>
                  <span class="count1"></span>
                </div>
                <!-- <div class="top">
                    <span class="tit">占用数：</span>
            ...
            <div class="circleItem">
              ...
              <div class="circleRight">
                <div class="top">
                  <span class="tit">研学路线：{{ reportDataName5 }}</span>
                  <span class="count1"></span>
                </div>
                <!-- <div class="top">
                    <span class="tit">占用数：</span>
          ...
          <div class="circleBox">
            <div class="circleItem">
              ...
              <div class="circleRight">
                <div class="top">
                  <span class="tit">研学路线：{{ reportDataName6 }}</span>
                  <span class="count1"></span>
                </div>
                <!-- <div class="top">
                    <span class="tit">占用数：</span>
            ...
            <div class="circleItem">
              ...
              <div class="circleRight">
                <div class="top">
                  <span class="tit">研学路线：{{ reportDataName7 }}</span>
                  <span class="count1"></span>
                </div>
                <!-- <div class="top">
                    <span class="tit">占用数：</span>
          ...
          <div class="circleBox">
            <div class="circleItem">
              ...
              <div class="circleRight">
                <div class="top">
                  <span class="tit">研学路线：{{ reportDataName8 }}</span>
                  <span class="count1"></span>
                </div>
                <!-- <div class="top">
                    <span class="tit">占用数：</span>
            ...
            <div class="circleItem">
              ...
              <div class="circleRight">
                <div class="top">
                  <span class="tit">研学路线：{{ reportDataName9 }}</span>
                  <span class="count1"></span>
                </div>
                <!-- <div class="top">
                    <span class="tit">占用数：</span>
