      ...
      <div class="main_center">
          ...
          >
            <div class="stars">
              ...
              <img
                ...
                alt=""
                v-for="(itm, idx) in item.starCount"
                :key="idx"
              />
            </div>
        ...
        <div class="topCount">
          <dv-border-box-8 class="top_left">
            ...
            <div class="counts">
              <CountUp :delay="delay" :endVal="14353" :options="options" />
            </div>
          </dv-border-box-8>
          <dv-border-box-8 class="top_center">
            <div class="tit">教师数</div>
            <div class="counts"><div class="counts">
              <CountUp :delay="delay" :endVal="4003" :options="options" />
            </div></div>
          </dv-border-box-8>
          <dv-border-box-8 class="top_right">
            <div class="tit">学生数</div>
            <div class="counts"><div class="counts">
              <CountUp :delay="delay" :endVal="363" :options="options" />
            </div></div>
          </dv-border-box-8>
        </div>
        <dv-border-box-10
    ...
    initHomeworkChart() {
      ...
      var option = {
        ...
        xAxis: {
          ...
          data: ['2023-08-10','2023-08-11','2023-08-12','2023-08-13'],
        },
        yAxis: [
          {
            name: "分钟",
