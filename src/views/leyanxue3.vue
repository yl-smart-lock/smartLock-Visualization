    ...
    <div class="main">
      ...
      <div class="main_left">
        ...
        >
          <div class="titss">
            ...
            <div class="tit_text">学校参与活动数量</div>
          </div>
      ...
      <div class="main_right">
        ...
        >
          ...
          <div class="titss">
            <dv-decoration-6 style="width: 150px; height: 20px" />
            <div class="tit_text">研学路线参与情况</div>
          </div>
            ...
            <div class="circlees">
              <div class="circleBox">
                <div class="circleItem">
                  ...
                  <div class="circleRight">
                    <div class="top">
                      <!-- <span class="tit">研学路线：{{ reportDataName }}</span> -->
                      <span class="tit">研学路线：爱国主义</span>
                ...
                <div class="circleItem">
                  ...
                  <div class="circleRight">
                    <div class="top">
                      <!-- <span class="tit">研学路线：{{ reportDataName1 }}</span> -->
                      <span class="tit">研学路线：科普教育</span>
              ...
              <div class="circleBox">
                ...
                <div class="circleItem">
                  ...
                  <div class="circleRight">
                    <div class="top">
                      <span class="tit">研学路线：生态保护区</span>
                      <span class="count1"></span>
                    </div>
                    <!-- <div class="top">
                    <span class="tit">占用数：</span>
...
export default {
  ...
  data() {
    return {
      ...
      tableList: [
        {
          mtff_title:'良渚繁华融入中华文明的辉煌研学报告',
          date:'2023-08-11'
        },
        {
          mtff_title:'良渚文化遗址研学报告',
          date:'2023-08-12'
        },
        {
          mtff_title:'中华文明文化延续研学报告',
          date:'2023-08-13'
        },
        {
          mtff_title:'良渚文明遗址研学报告',
          date:'2023-08-13'
        },
      ],
      indicator1: [],
  ...
  methods: {
    ...
    getReportsLatest() {
      get_reports_latest().then((res) => {
        // this.tableList = res;
        // this.tableList = [... this.tableList,...this.tableList,...this.tableList]
      });
    },
    getAgencyType() {
    ...
    getActivity() {
      get_activity().then((res) => {
        ...
        var data1= {
            data:[
                {name:'余杭中学',value:133},
                {name:'余杭实验中学',value:126},
                {name:'余杭高级中学',value:223},
                {name:'杭州余杭东方未来学校',value:133},
                {name:'杭州学军中学',value:189},
            ]
        }
        res.forEach((item) => {
            item['name'] = item.school_name
            item['value'] = item.ma_cnt
            data1.data.push(item)
...
@keyframes scroll-up {
  ...
  100% {
    transform: translateY(-50%); /* 最终状态，向上偏移100% */
  }
}
...
.conect {
  ...
  .conectBox {
    animation: scroll-ups 10s linear infinite;
  }
}
.tableHead {
  width: 100%;
